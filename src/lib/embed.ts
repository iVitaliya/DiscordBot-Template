import type {
    APIEmbed, APIEmbedAuthor, APIEmbedField,
    APIEmbedFooter, APIEmbedImage,
    APIEmbedProvider, APIEmbedThumbnail, APIEmbedVideo
} from "discord.js";
...
export class MessageEmbed implements APIEmbed {
     ...
     * See https://discord.com/developers/docs/resources/channel#embed-object-embed-author-structure
     */
    public setAuthor(data: RemoveField<APIEmbedAuthor, "icon_url" | "proxy_icon_url">): MessageEmbed {
        this.author = {
